  ...
  return (
    <div className="min-h-screen flex flex-col selection:bg-primary/30">
      ...
      <header className="border-b border-slate-200/60 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            <Link href="/history" className="hover:text-primary transition-colors flex items-center gap-2 text-slate-600 font-bold">
      ...
      <main className="flex-1">
        ...
        {/* Features Section */}
        <section className="py-24 px-4 bg-white/40 backdrop-blur-sm border-t border-slate-100">
            ...
            <div className="grid md:grid-cols-2 gap-20 items-center max-w-6xl mx-auto">
              ...
              <div className="relative group p-12 misty-glass rounded-[2rem] text-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-500">See how our AI analyzes information across the web.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t border-slate-100 py-16 px-4 bg-white/90">
