      ...
      <Card className="misty-glass border-slate-300 shadow-2xl overflow-hidden rounded-[2rem]">
        <CardContent className="p-0">
          <div className="flex flex-col">
            <div className="p-10 space-y-6 bg-slate-100/60">
              ...
              {selectedImage ? (
                ...
                <Textarea
                  ...
                  className="min-h-[200px] text-3xl border-2 border-slate-200/80 rounded-2xl focus-visible:ring-2 focus-visible:ring-primary/20 px-12 py-10 bg-white/80 resize-none placeholder:text-slate-500 text-slate-900 font-black tracking-tight leading-tight transition-all duration-300"
                  value={inputText}
            ...
            <div className="bg-slate-50/90 border-t border-slate-100 p-8 flex items-center justify-between">
